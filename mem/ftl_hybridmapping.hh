...
private:
    ...
    STATE insert_into_data_block(const Addr lpn, const Mask & mask, Addr &ppn);
    STATE insert_into_log_block(const Addr lpn, const Mask & mask, Addr &ppn);
    ...
    STATE getppn(const Addr lpn, Mask & mask, Addr & ppn);
    STATE merge(const Addr lpn);
    STATE allocate_new_page(const Addr lpn, const Mask & mask, Addr & ppn); 
